      ...
      <main className="max-w-4xl mx-auto px-6 pt-40 pb-32">
        ...
        >
          ...
          <div className="bg-white text-black p-8 md:p-16 rounded-2xl shadow-inner font-serif max-w-[210mm] mx-auto min-h-[297mm]">
            <div className="border-b-2 border-black pb-6 mb-8">
              <h1 className="text-3xl font-bold tracking-tight mb-2">ALEX NYANGARESI OBWOGI</h1>
              <div className="text-sm flex flex-wrap gap-x-4 gap-y-1 text-gray-700">
                <span>Nairobi, Kenya</span>
                <span className="font-bold">|</span>
                <span>obwogialex728@gmail.com</span>
                <span className="font-bold">|</span>
                <span>+254 706 050 538</span>
                <span className="font-bold">|</span>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <SectionHeading subtitle="GENERATION_COMPLETE" title="Ready." />
            ...
            <div className="mt-20 pt-12 border-t border-white/5 grid grid-cols-1 md:grid-cols-3 gap-8">
               <div className="flex items-center gap-4 justify-center">
                  ...
                  <span className="text-[9px] font-mono text-gray-600 uppercase tracking-widest">ATS_Optimized</span>
               </div>
               <div className="flex items-center gap-4 justify-center">
                  <Sparkles className="w-5 h-5 text-tiktok-cyan/40" />
                  <span className="text-[9px] font-mono text-gray-600 uppercase tracking-widest">AI_Tailored</span>
               </div>
               <div className="flex items-center gap-4 justify-center">
                  <FileText className="w-5 h-5 text-tiktok-cyan/40" />
                  <span className="text-[9px] font-mono text-gray-600 uppercase tracking-widest">Production_Ready</span>
               </div>
            </div>
          </div>
        </motion.div>

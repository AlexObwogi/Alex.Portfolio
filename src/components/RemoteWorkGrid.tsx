...
import { ExternalLink, Terminal, Shield, Cpu, Globe, Video, FileText, ChevronRight, Play, Maximize2, X, Briefcase } from 'lucide-react';
    ...
    <div className="space-y-12">
      ...
      <div className="flex flex-col gap-8">
        <div className="space-y-4">
          <h4 className="text-[10px] font-mono text-gray-500 uppercase tracking-[0.4em]">Service_Categories</h4>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-t border-white/5 pt-8">
          <div className="flex flex-wrap gap-2">
            <span className="text-[10px] font-mono text-gray-600 uppercase tracking-widest self-center mr-2">Quick_Stack::</span>
            {allTech.map(tech => (
              <button 
                key={tech}
          ...
          <div className="flex items-center gap-4 bg-white/5 p-2 rounded-2xl border border-white/10">
            <span className="text-[9px] font-mono text-gray-600 uppercase tracking-widest ml-4">Sort_By::</span>
            <button 
              onClick={() => setSortBy('latest')}
              className={cn(
                "px-4 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all",
                sortBy === 'latest' ? "bg-white/10 text-white" : "text-gray-600 hover:text-gray-400"
              )}
            >
              Date
            </button>
            <button 
              ...
              className={cn(
                "px-4 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all",
                sortBy === 'platform' ? "bg-white/10 text-white" : "text-gray-600 hover:text-gray-400"
              )}
            >
              Platform
            </button>
          ...
          <div className="fixed inset-0 z-[550] flex items-center justify-center p-4 lg:p-12">
            ...
            >
               ...
               <div className="lg:w-1/2 relative bg-black">
                  ...
                  <div className="absolute bottom-12 left-12 right-12 space-y-4">
                     <div className="flex items-center gap-3">
                        ...
                        <span className="text-[10px] font-mono tracking-[0.4em] text-tiktok-cyan uppercase">Remote_Operation</span>
                     </div>
               ...
               <div className="lg:w-1/2 p-12 lg:p-16 overflow-y-auto custom-scrollbar space-y-12">
                  ...
                  <div className="space-y-4">
                     <h4 className="text-[10px] font-mono text-gray-400 uppercase tracking-[0.4em]">Project_Overview</h4>
                  ...
                  <div className="space-y-6">
                     <h4 className="text-[10px] font-mono text-gray-400 uppercase tracking-[0.4em]">Tech_Infrastructure</h4>
                  ...
                  {selectedWork.liveUrl && (
                    ...
                    >
                      Execute_Live_Module <ExternalLink className="w-4 h-4" />
                    </a>
                  )}
               </div>
            </motion.div>
